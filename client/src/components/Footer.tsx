...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-gray-900 to-black text-white pt-8 pb-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className={`grid grid-cols-1 md:grid-cols-4 gap-6 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <div className="md:col-span-1">
            ...
            <div className="mt-4 bg-white/5 backdrop-blur-sm p-4 rounded-lg border border-white/10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/size-chart" className="text-gray-400 hover:text-red-400 transition-colors flex items-center group">
                  <span className="opacity-0 group-hover:opacity-100 mr-2 transition-opacity">
                    <ArrowRight className="h-3 w-3" />
                  </span>
                  Size Charts
        ...
        <div className="mt-8 pt-6 border-t border-gray-800/70 flex flex-col md:flex-row justify-between items-center">
