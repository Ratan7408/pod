            ...
            <div className="flex-shrink-0 flex items-center" style={{ marginLeft: '-1rem' }}>
              <Link href="/" className="glass-brand">
                <div className="flex items-center">
                  <span className="animated-text text-lg font-bold text-orange-500">ANIME</span>
                  <span className="animated-text text-lg font-bold text-orange-500 ml-1">INDIA</span>
                  <span className="animated-text text-sm font-medium text-white ml-2">POD</span>
                </div>
              </Link>
            </div>
